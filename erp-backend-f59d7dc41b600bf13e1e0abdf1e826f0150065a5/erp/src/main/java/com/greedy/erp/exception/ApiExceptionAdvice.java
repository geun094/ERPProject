...
import com.greedy.erp.exception.dto.ApiExceptionDTO;
...
public class ApiExceptionAdvice {
	...
	@ExceptionHandler(DuplicatedEmpEmailException.class)
	public ResponseEntity<ApiExceptionDTO> exceptionHandler(DuplicatedEmpEmailException e) {
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
				.body(new ApiExceptionDTO(HttpStatus.BAD_REQUEST, e.getMessage()));
	} 
}
