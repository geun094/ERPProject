...
public class Approval {
	...
	public Approval(int approvalCode, int empCode, int statusCode, String docType, Date approvalDate, String approvalTitle,
		String approvalContent, String oldFileName, String newFileName, String link, String vacationType,
		Date vacationStartDate, Date vacationEndDate) {
		super();
   ...
   public int getApprovalCode() {
	...
	public String toString() {
		return "Approval [approvalCode=" + approvalCode + ", empCode=" + empCode + ", statusCode=" + statusCode
	...
	public void preActive() {
		this.approvalDate = this.approvalDate == null ? new Date(System.currentTimeMillis()) : this.approvalDate;
	}
